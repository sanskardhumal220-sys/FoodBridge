...
const Privacy = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 py-12 lg:py-24 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">Your data is safe with us. Learn how we protect it.</p>
        </motion.div>
        ...
        >
          {policies.map((policy) => (
            <motion.div 
              ...
              className="glass p-8 rounded-3xl border border-gray-100 dark:border-gray-800 hover:border-primary-300 dark:hover:border-primary-700 transition-colors duration-300 relative overflow-hidden group"
            >
