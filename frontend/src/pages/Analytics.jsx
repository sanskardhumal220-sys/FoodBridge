...
const Analytics = () => {
  ...
  return (
    <div className="w-full min-h-[calc(100vh-64px)] py-12 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <span className="text-sm font-semibold text-gray-700 dark:text-gray-300 tracking-wide uppercase">Real-time Impact</span>
          </motion.div>
          ...
          >
            Global <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-accent-500">Analytics Dashboard</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            Track our collective progress in fighting hunger and reducing environmental impact through food rescue.
          </motion.p>
        </div>
        ...
        >
          <div className="flex justify-between items-center mb-8 relative z-10">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Impact Over Time</h2>
              <p className="text-gray-500 dark:text-gray-400">Monthly growth in food rescued and meals served</p>
            </div>
          ...
          <div className="h-64 w-full flex items-end justify-between space-x-2 relative z-10">
            {[40, 55, 45, 60, 75, 65, 80, 95, 85, 100, 90, 110].map((height, i) => (
              <motion.div
                key={i}
                initial={{ height: 0 }}
              ...
              >
                <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-xs py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none font-medium shadow-lg z-20">
                  Month {i+1}
                </div>
              </motion.div>
            ))}
          ...
          <div className="absolute inset-0 pointer-events-none flex flex-col justify-between py-8 px-8 z-0">
            <div className="mt-16 h-full flex flex-col justify-between pb-8">
              {[1,2,3,4,5].map((_, i) => (
                <div key={i} className="w-full h-px bg-gray-200/50 dark:bg-gray-800/50" />
              ))}
            </div>
          </div>
        </motion.div>
