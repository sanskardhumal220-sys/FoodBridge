  ...
  return <div className="min-h-screen bg-gray-50 dark:bg-gray-950 py-12 lg:py-24 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        duration: 0.5
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-4">{t("terms.text1")}</h1>
          <p className="text-lg text-gray-600 dark:text-gray-400">{t("terms.text2")}</p>
        </motion.div>

        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
          {sections.map(section => <motion.div key={section.id} variants={itemVariants} className="glass p-6 md:p-8 rounded-2xl border border-gray-200 dark:border-gray-800 hover:shadow-lg transition-shadow duration-300">
        ...
        delay: 1
      }} className="mt-16 text-center text-sm text-gray-500 dark:text-gray-400">{t("terms.text3")}</motion.div>
      </div>
    </div>;
};
