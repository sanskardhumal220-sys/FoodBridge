...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center overflow-hidden">
      {/* Hero Section */}
      <section 
        className="w-full relative min-h-[90vh] flex items-center py-20 lg:py-32 bg-white dark:bg-[#0a0a0a]"
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
            ...
            <div className="text-center lg:text-left max-w-2xl z-10">
              ...
              >
                ...
                <Link to="/dashboard" className="glass-card text-gray-800 dark:text-gray-200 px-8 py-4 rounded-full font-bold transition-all hover:-translate-y-1 hover:shadow-xl flex justify-center items-center">
                  Explore Platform
                </Link>
              </motion.div>
            </div>
            ...
            >
              ...
              >
                <img 
                  ...
                  className="w-full h-auto drop-shadow-2xl relative z-10 rounded-[3rem] border border-white/20 glass"
                />
              </motion.div>
            </motion.div>
          </div>
      ...
      <section className="w-full py-32 bg-gray-50 dark:bg-gray-900 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold mb-4 dark:text-white">Why Choose FoodBridge?</h2>
            <p className="text-xl text-gray-600 dark:text-gray-400">Our platform provides the most efficient, transparent, and impactful way to redistribute surplus food.</p>
          </motion.div>
          ...
          >
            <div className="lg:col-span-2 lg:row-span-2">
              <FeatureCard 
                ...
                className="h-full flex flex-col justify-center bg-gradient-to-br from-primary-50 to-white dark:from-primary-900/20 dark:to-[#0f0f0f]"
              />
            </div>
            <div className="lg:col-span-1 lg:row-span-1">
              <FeatureCard 
                icon={<MapPin className="w-8 h-8 text-accent-500" />}
                title={t('home.feat2_title')}
                description={t('home.feat2_desc')}
                variants={itemVariants}
                className="h-full bg-gradient-to-br from-accent-50 to-white dark:from-accent-900/20 dark:to-[#0f0f0f]"
              />
            </div>
            <div className="lg:col-span-1 lg:row-span-1">
              <FeatureCard 
                ...
                variants={itemVariants}
                className="h-full bg-gradient-to-br from-blue-50 to-white dark:from-blue-900/20 dark:to-[#0f0f0f]"
              />
            </div>
          </motion.div>
        </div>
...
const FeatureCard = ({ icon, title, description, variants, className = "" }) => (
  <motion.div 
    variants={variants}
